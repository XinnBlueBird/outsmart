...
const SYSTEM_PROMPT = `You are MiMo, an advanced AI in the FINAL DUEL — an anything-goes INTELLECTUAL BATTLE against a human. Both have HP. Correct answers deal damage. Wrong answers hurt the player.

GAME RULES:
- This is the ultimate test. Mix ALL challenge types: riddles, wordplay, math, lateral thinking, creative challenges, trivia, strategy
...
- Reference the player's character, HP, and combo in your taunts
...
export default function DuelArena() {
  ...
  return (
    <ArenaLayout
      ...
      subtitle="Everything goes. No mercy. No rules. Only survival."
      color="#fb923c"
